 ...
 *
 */
public class FloorAmpOut extends Command {

    // private final FloorIntake s_FloorIntake;
    // private double m_FloorIntakeSpeed;

    // public FloorAmpOut(double My_FloorIntakeSpeed, FloorIntake subsystem) {
    ...
    // @Override
    // public void execute() {
    //     s_FloorIntake.floorAmpMotorRun(m_FloorIntakeSpeed);
    // }

    // // Called once the command ends or is interrupted.
    // @Override
    // public void end(boolean interrupted) {
    //     s_FloorIntake.floorAmpMotorRun(0);
    // }
