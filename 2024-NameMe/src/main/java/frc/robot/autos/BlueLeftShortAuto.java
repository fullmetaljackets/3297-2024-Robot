...
public class BlueLeftShortAuto extends SequentialCommandGroup {

    public BlueLeftShortAuto(Swerve s_Swerve, ShooterOne s_ShooterOne, ShooterTwo s_ShooterTwo, ShooterTrigger s_ShooterTrigger){
