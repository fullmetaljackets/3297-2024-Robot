...
public class RedLeftShortDelayAuto extends SequentialCommandGroup {

    public RedLeftShortDelayAuto(Swerve s_Swerve, ShooterOne s_ShooterOne, ShooterTwo s_ShooterTwo, ShooterTrigger s_ShooterTrigger){
        TrajectoryConfig config =
            ...
            Trajectory myTrajectory1 =
                TrajectoryGenerator.generateTrajectory(
                    ...
                    List.of(),
                    // Back up 2.4 meters
                    new Pose2d(-2, -1.33, Rotation2d.fromDegrees(0)),
                    config);
            ...
            Trajectory myTrajectory2 =
                TrajectoryGenerator.generateTrajectory(
                    ...
                    // Pass through these two interior waypoints, making an 's' curve path
                    List.of(),
                    // End 2.6 meters towards middle of field facing forward
                    new Pose2d(-3.66, 0.33, Rotation2d.fromDegrees(-50)),
                    config);
