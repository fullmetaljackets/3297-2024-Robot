...
public class BlueLeftLongDelayAuto extends SequentialCommandGroup {

    public BlueLeftLongDelayAuto(Swerve s_Swerve, ShooterOne s_ShooterOne, ShooterTwo s_ShooterTwo, ShooterTrigger s_ShooterTrigger){
