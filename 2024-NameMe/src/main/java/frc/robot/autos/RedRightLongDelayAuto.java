...
public class RedRightLongDelayAuto extends SequentialCommandGroup {

    public RedRightLongDelayAuto(Swerve s_Swerve, ShooterOne s_ShooterOne, ShooterTwo s_ShooterTwo, ShooterTrigger s_ShooterTrigger){
