...
public class BlueRightShortDelayAuto extends SequentialCommandGroup {

    public BlueRightShortDelayAuto(Swerve s_Swerve, ShooterOne s_ShooterOne, ShooterTwo s_ShooterTwo, ShooterTrigger s_ShooterTrigger){
