...
public class RedLeftShortAuto extends SequentialCommandGroup {

    public RedLeftShortAuto(Swerve s_Swerve, ShooterOne s_ShooterOne, ShooterTwo s_ShooterTwo, ShooterTrigger s_ShooterTrigger){
