...
public class RedLeftLongDelayAuto extends SequentialCommandGroup {

    public RedLeftLongDelayAuto(Swerve s_Swerve, ShooterOne s_ShooterOne, ShooterTwo s_ShooterTwo, ShooterTrigger s_ShooterTrigger){
