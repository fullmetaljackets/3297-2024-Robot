...
public class RedRightLongAuto extends SequentialCommandGroup {

    public RedRightLongAuto(Swerve s_Swerve, ShooterOne s_ShooterOne, ShooterTwo s_ShooterTwo, ShooterTrigger s_ShooterTrigger){
