...
public class BlueRightLongAuto extends SequentialCommandGroup {

    public BlueRightLongAuto(Swerve s_Swerve, ShooterOne s_ShooterOne, ShooterTwo s_ShooterTwo, ShooterTrigger s_ShooterTrigger){
